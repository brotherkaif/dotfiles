...
-- Step one ===================================================================
-- Use Neovim's default color scheme. On Omarchy it is replaced by the active
-- theme via 'plugin/45_omarchy.lua'.
--
-- See also:
-- - `:h colorscheme` - list of other color schemes
-- - `:h mini.nvim-color-schemes` - color schemes that come with 'mini.nvim'
...
-- You can try 'mini.hues'-based color schemes (uncomment with `gcc`):

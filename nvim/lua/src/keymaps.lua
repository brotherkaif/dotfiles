...
vim.keymap.set('n', '<leader>fe', function() require('mini.extra').pickers.explorer() end,
	{ desc = '[f]ind in [e]xplorer' })
vim.keymap.set('n', '<leader>fd', function() require('mini.extra').pickers.diagnostic() end,
	{ desc = '[f]ind [d]iagnostic' })
vim.keymap.set('n', '<leader>fc', function() require('mini.extra').pickers.commands() end, { desc = '[f]ind [c]ommand' })
vim.keymap.set('n', '<leader>fv', function() require('mini.extra').pickers.visit_paths() end,
	{ desc = '[f]ind recent [v]isits' })
...
vim.keymap.set('n', '<leader>mf', function() require('mini.map').toggle_focus() end,
	{ desc = 'mini [m]ap toggle [f]ocus' })
